                ...
                <div
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    onClick={() => {
                      ...
                      {unreadMessageCount > 0 &&
                    <span className="absolute -top-0.5 -right-1.5 min-w-[20px] h-[20px] bg-blue-500 !text-white text-xs font-bold rounded-full flex items-center justify-center px-1 border-2 border-white">
                          {unreadMessageCount > 9 ? '9+' : unreadMessageCount}
                        </span>
                    }
                    </div>
