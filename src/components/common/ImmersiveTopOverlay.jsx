...
export default function ImmersiveTopOverlay({ delivery, store, patient, isPickup, storeColor, finalDisplayName }) {
  const batchTracking = formatBatchTracking(delivery, store);

  return (
    <div className="absolute left-2 right-2 top-2 z-[350] pointer-events-none">
