  ...
  showDragHandle = false, dragHandleProps, compact = false, isRailCentered = true })
{
  ...
  return (
    <motion.div
      ...
      <Card
        data-route-completed-condensed={showCompletedRouteCenteredCondensed ? "true" : "false"} className={`bg-card text-card-foreground rounded-xl border shadow-md cursor-pointer hover:shadow-lg transition-all duration-200 ${showIncompleteRouteSideCondensed ? 'min-h-[100px]' : showCenteredIncompleteCollapsed ? 'min-h-[95px]' : 'min-h-[100px]'} min-w-[338px] max-w-[338px] border-blue-500`}
