  ...
  const overlay = (
    <div {...ContainerProps}>
      ...
      {(() => {
        ...
        const contentLeft = anchorEl ? (anchorEl.getBoundingClientRect().left + 12) : viewportPadding;
        const contentRight = anchorEl ? (anchorEl.getBoundingClientRect().right - 12) : (window.innerWidth - viewportPadding);
