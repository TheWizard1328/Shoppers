...
export default function PhotoCapture({ onSave, onCancel, maxPhotos = 3 }) {
  ...
  }, [capturedPhotos.length, maxPhotos, stopCamera]);
  ...
  const handleSave = () => {
    onSave(capturedPhotos.map(p => p.blob));
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-[99999] bg-black flex items-center justify-center" style={{ aspectRatio: 'auto', orientation: 'landscape' }}>
