  ...
  return ReactDOM.createPortal(
    ...
    >
      <div className="rounded-xl shadow-2xl w-full h-full md:max-w-2xl md:max-h-[90vh] flex flex-col overflow-hidden bg-surface">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4" style={{ background: 'var(--bg-slate-50)' }}>
          {error && (
            <div className="border rounded-lg p-3 text-sm" style={{ background: 'var(--bg-red-50, #fef2f2)', borderColor: 'var(--border-red-200, #fecaca)', color: 'var(--text-red-700, #b91c1c)' }}>
              {error}
            </div>
          )}
          ...
          <div className={`relative ${isCameraActive ? '' : 'hidden'}`}>
            <video 
              ...
              style={{ background: 'var(--bg-black, #000000)', maxHeight: '55dvh', objectFit: 'cover' }}
            />
        ...
        <div className="border-t p-4 flex gap-3 justify-end bg-surface border-surface">
