  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <Card className="border-2 border-emerald-500 shadow-2xl bg-surface" style={{ borderColor: '#10b981' }}>
            <CardHeader className="text-center space-y-2 pb-4">
              ...
              <CardDescription className="text-base text-soft">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-body-2">
                  Select Your City *
                </label>
                <div className="grid grid-cols-1 gap-2 max-h-[300px] overflow-y-auto p-1">
                  {isLoadingCities && (
                    <div className="flex items-center justify-center py-8 gap-2 text-soft">
                      <Loader2 className="w-5 h-5 animate-spin" />
                      <span className="text-sm">Loading cities…</span>
                    </div>
                  )}
                  {!isLoadingCities && !cities.length && (
                    <div className="flex flex-col items-center justify-center py-8 gap-3 text-soft">
