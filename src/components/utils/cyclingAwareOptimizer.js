...
export async function invokeOptimizeAwareCycling({
  ...
  // purgeAndRegeneratePolylines groups consecutive same-transport_mode segments
  // and calls getHereDirections once per group — driving/cycling/driving is
  // handled automatically with no extra params needed.
