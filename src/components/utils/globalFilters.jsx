...
export const globalFilters = {
  ...
  setSelectedCityId: (cityId) => {
    ...
    if (changed) {
      ...
      // Notify SW to switch active tile cache to the new city's bucket.
      // This is a no-op if SW isn't registered yet (tileCacheManager handles init).
      if (newCityId && newCityId !== 'all' && typeof navigator !== 'undefined' &&
