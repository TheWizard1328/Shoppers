...
// Consolidated into geoUtils — identical math (km), single source of truth.
import { haversineKm } from './geoUtils';
const calculateDistanceBetweenCoords = (lat1, lon1, lat2, lon2) => haversineKm(lat1, lon1, lat2, lon2);
