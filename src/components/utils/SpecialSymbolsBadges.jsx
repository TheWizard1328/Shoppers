...
export default function SpecialSymbolsBadges({
  ...
  return (
    <Badge className="bg-yellow-400 text-black mt-1 px-1 py-0.5 text-sm font-bold rounded-[10px] border transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent shadow hover:bg-primary/80 h-5 inline-flex items-center gap-0.5">
