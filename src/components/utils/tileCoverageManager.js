...
const PREFETCH_BATCH_SIZE      = 8;                     // prefetch 8 tiles at a time
const PREFETCH_BATCH_DELAY_MS  = 500;                   // 500ms between batches (low priority)
const STALE_TILE_TTL_MS        = 30 * 24 * 60 * 60 * 1000; // 30 days — prune IDB coverage older than this
