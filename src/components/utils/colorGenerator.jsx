...
const STORE_COLOR_PALETTE = [
  '#71717A', // Gray fallback (Index 0 - was empty string, now safe default)
  '#2196F3', // Blue (Index 1) - Removed empty string
  '#FF9800', // Orange (Index 2)
  '#E91E63', // Pink (Index 3)
...
export const getStoreColor = (store) => {
    ...
    const color = generateStoreColor(store.name || store.id || 'Unknown');
    // Ensure we never return an empty string (would crash Leaflet's setOptions)
    return color || '#71717A';
};
