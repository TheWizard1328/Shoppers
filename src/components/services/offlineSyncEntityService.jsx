        ...
        if (storeName) {
          ...
          if (entityName === 'Delivery') {
            ...
            const mergedRecords = records.map(incoming => {
              ...
              // Merge: keep incoming values but preserve key fields if missing in incoming
              return {
                ...incoming,
                ...
                delivery_time_start: incoming.delivery_time_start || existing.delivery_time_start,
                delivery_time_end: incoming.delivery_time_end || existing.delivery_time_end,
                delivery_time_eta: incoming.delivery_time_eta || existing.delivery_time_eta
              };
            });
