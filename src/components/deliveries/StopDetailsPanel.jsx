...
const statusConfig = {
  ...
  cancelled: { color: 'bg-slate-100 text-slate-800 border-slate-300 dark:bg-slate-700/30 dark:text-slate-300 dark:border-slate-600', label: 'Cancelled', icon: XCircle },
  ...
  projected: { color: 'bg-gray-100 text-gray-700 border-gray-300 dark:bg-gray-700/30 dark:text-gray-300 dark:border-gray-600', label: 'Projected', icon: Clock }
};
