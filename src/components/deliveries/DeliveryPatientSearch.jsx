                ...
                <Checkbox
                  ...
                  <div className="text-xs text-slate-500 truncate">
                    ...
                    <div className="flex flex-col gap-1 ml-1">
                      <Button type="button" variant="ghost" size="sm" className="justify-end rounded-md text-xs h-6 px-2 hover:bg-blue-100" onClick={(e) => {e.stopPropagation();onDuplicatePatient(patient);}} title="Duplicate Patient">
                        <span className="text-blue-700">Duplicate</span>
                        <Copy className="w-3 h-3 text-blue-600" />
                      </Button>
                      <Button type="button" variant="ghost" size="sm" className="justify-end rounded-md text-xs h-6 px-2 hover:bg-purple-100" onClick={(e) => {e.stopPropagation();onNewAddressPatient(patient);}} title="New Address">
