...
export default function DeliveryPatientSearch({
  ...
  return (
    <div className="px-3 rounded-lg relative flex-1 space-y-2 border min-h-[110px] max-h-[110px]" style={{ background: 'var(--bg-slate-50)', borderColor: 'var(--border-slate-200)' }}>
