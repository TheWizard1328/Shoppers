  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <Select value={driverFilter} onValueChange={handleDriverChange} disabled={userHasRole(currentUser, 'driver')}>
          <SelectTrigger className={`w-[140px] bg-white border-slate-300 ${userHasRole(currentUser, 'driver') ? 'opacity-60 cursor-not-allowed' : ''}`}><SelectValue placeholder="Select driver" /></SelectTrigger>
