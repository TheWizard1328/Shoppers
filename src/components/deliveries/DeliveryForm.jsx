  ...
  useEffect(() => {
    if (delivery) {
      ...
      setFormData({
        ...
        cp_envelopes: patient?.cp_envelopes !== undefined && patient?.cp_envelopes !== null ? patient.cp_envelopes : (delivery.cp_envelopes || 0),
