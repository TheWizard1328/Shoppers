              ...
              >
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 text-body" style={{ backgroundColor: 'var(--bg-slate-100)', border: '1px solid var(--border-slate-200)', '--tw-ring-color': 'var(--primary-color)' }}
                  />
                  <button
                    onClick={handleSend}
