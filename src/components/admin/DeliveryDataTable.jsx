            ...
            <tbody>
              {paginatedDeliveries.map(delivery => (
                <tr key={delivery.id} className="border-b hover:bg-slate-50 dark:bg-slate-800 dark:hover:bg-slate-800">
                  ...
                  <td className="p-3 text-sm text-slate-600 dark:text-slate-400">{getStoreName(delivery.store_id)}</td>
                  <td className="p-3 text-sm text-slate-600 dark:text-slate-400">{delivery.driver_name || "Unassigned"}</td>
                  <td className="p-3">
