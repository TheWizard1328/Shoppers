    ...
    <Card>
      ...
      <CardContent className="px-6 py-1">
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          <Select value={selectedCodFilter} onValueChange={onCodFilterChange} disabled={isLoadingData}><SelectTrigger className="w-40"><SelectValue placeholder="Select COD" /></SelectTrigger><SelectContent><SelectItem value="all">All COD's</SelectItem><SelectItem value="cash">Cash</SelectItem><SelectItem value="debit">Debit</SelectItem><SelectItem value="credit">Credit</SelectItem><SelectItem value="check">Check</SelectItem></SelectContent></Select>
