...
export default function SquareCodViewSwitcher({ activeView, onChange, counts = {}, hidden = false }) {
  ...
  return (
    <div className="flex flex-row gap-2 md:flex md:flex-wrap md:items-center md:justify-start">
      {VIEWS.map((view) => {
        ...
        return (
          <Button
            ...
            className="flex-1 h-auto min-h-[3rem] justify-center rounded-2xl px-2 py-1.5 md:h-9 md:flex-none md:w-[130px] md:rounded-full md:px-3"
          >
