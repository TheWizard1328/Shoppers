      ...
      <CardContent className="p-2.5 md:p-3 flex flex-col justify-between h-full my-1">
        ...
        <div className="flex items-start gap-1.5 mb-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-400 font-mono truncate leading-tight">
        ...
        <p className="text-[10px] text-slate-400 dark:text-slate-400 mt-1.5 leading-tight">
