      ...
      <CardContent className="p-2.5 md:p-3 flex flex-col justify-between h-full my-1">
        ...
        <div className="flex items-start gap-1.5 mb-2">
          ...
          <div className="min-w-0">
            <h3 className="font-semibold text-slate-900 dark:text-slate-100 dark:text-slate-50 text-xs md:text-sm leading-tight truncate">
              {location.name}
            </h3>
            <p className="text-[10px] text-slate-400 dark:text-slate-500 dark:text-slate-400 font-mono truncate leading-tight">
        ...
        <div className="grid grid-cols-2 gap-1.5">
          <div className="rounded p-1.5" style={{ background: 'rgba(0,0,0,0.04)' }}>
            <div className="text-[10px] text-slate-500 dark:text-slate-400 dark:text-slate-500 leading-tight">Total</div>
            <div className="text-sm md:text-base font-bold text-emerald-600 dark:text-emerald-400 leading-tight">
              ${codTotal.toFixed(2)}
            </div>
          </div>
          <div className="rounded p-1.5" style={{ background: 'rgba(0,0,0,0.04)' }}>
            <div className="text-[10px] text-slate-500 dark:text-slate-400 dark:text-slate-500 leading-tight">Items</div>
        ...
        <p className="text-[10px] text-slate-400 dark:text-slate-500 dark:text-slate-400 mt-1.5 leading-tight">
