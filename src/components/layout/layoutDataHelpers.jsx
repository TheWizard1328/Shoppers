...
export const applyFullDataToState = ({
  ...
  // A full replacement wipes other drivers' data if the incoming set is date-scoped
  // or otherwise incomplete (e.g. a city-filtered sync or a partial offline DB read).
