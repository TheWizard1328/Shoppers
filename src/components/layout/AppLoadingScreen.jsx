  ...
  return (
    <div className="h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-800">
      <div className="text-center px-6">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-lg font-medium">Loading RxDeliver...</p>
        {showRetryHint && (
          <div className="mt-4 space-y-3">
            <p className="text-sm text-slate-500 dark:text-slate-400">If loading stays stuck, press F5 to retry.</p>
