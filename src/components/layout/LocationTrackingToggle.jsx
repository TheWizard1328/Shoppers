  ...
  return (
    <div className="flex items-center gap-2">
      <div className="flex flex-col">
        ...
        <Label htmlFor="location-toggle" className="text-[10px] text-slate-500 dark:text-slate-400 leading-tight">
          With Other Drivers
        </Label>
        {permissionStatus && (
          <span className="text-[10px] text-slate-500 dark:text-slate-400 leading-tight">{permissionStatus}</span>
        )}
