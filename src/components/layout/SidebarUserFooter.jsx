        ...
        <div className="rounded-lg flex items-center gap-3 px-2">
          ...
          <div
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-sm truncate flex items-center gap-1 text-body">
            ...
            <LogOut className="w-4 h-4 text-slate-400 dark:text-slate-400 flex-shrink-0 hidden" />
            }
          </div>
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              title="Messages">
              <MessageCircle className="w-5 h-5 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300" fill={unreadMessageCount > 0 ? '#10b981' : 'none'} />
              {unreadMessageCount > 0 &&
