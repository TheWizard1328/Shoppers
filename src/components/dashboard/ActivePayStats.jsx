...
export default function ActivePayStats({
  ...
  const tooltipValues = {
    ...
    pay: isLoadingPayrollStats ? 'Loading...' : `Total Pay: $${displayPay.toFixed(2)} (After Hours patient deliveries 2x, AH pickups 1x; N/C base excluded; oversized & extra km included)`,
