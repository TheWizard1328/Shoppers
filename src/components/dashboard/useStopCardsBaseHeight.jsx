...
export function useStopCardsBaseHeight({
  ...
  // NOTE: getMapPadding() in Dashboard.jsx also reads this height directly from the
  // DOM at call-time as the primary source (this state is a fallback), so a lag
  // between the DOM and this state updating no longer causes a double-fit.
  useEffect(() => {
