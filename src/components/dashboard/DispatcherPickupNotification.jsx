...
const calculateDistance = (lat1, lon1, lat2, lon2) => haversineMeters(lat1, lon1, lat2, lon2);
    ...
    <AnimatePresence>
      {activeNotification && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="fixed top-[calc(env(safe-area-inset-top,0px)+1rem)] right-4 z-[9999] max-w-md"
        >
          <div 
