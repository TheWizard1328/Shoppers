...
const DeliveryRow = memo(({
  ...
  return (
    ...
    <div
      onClick={handleRowClick} className="py-2 grid min-w-max grid-cols-[90px_120px_100px_100px_150px,1fr)_minmax(300px,1fr)_100px_100px_100px_100px_120px] gap-1 border-b cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/60"
