...
const DeliveryRow = memo(({
  ...
  return (
    ...
    <div
      onClick={handleRowClick} className="px-4 py-2 grid min-w-max grid-cols-[120px_120px_80px_minmax(300px,1fr)_minmax(200px,1fr)_100px_100px_40px_100px_120px] gap-2 border-b cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/60"
