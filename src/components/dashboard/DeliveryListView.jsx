...
const DeliveryRow = memo(({
  ...
  return (
    ...
    <div
      onClick={handleRowClick} className="py-2 grid min-w-max grid-cols-[90px_120px_100px_100px_minmax(250px,1fr)_minmax(200px,1fr)_100px_100px_100px_100px_120px] gap-1 border-b cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/60"
        ...
        <div className="sticky top-0 flex-shrink-0 border-b z-20" style={{ background: 'var(--bg-slate-50)', borderColor: 'var(--border-slate-200)' }}>
          ...
          <div
            ...
            className="delivery-list-header-scroll max-w-full overflow-x-auto overflow-y-hidden">
              ...
              <div className="grid min-w-max grid-cols-[90px_120px_100px_100px_minmax(300px,1fr)_minmax(200px,1fr)_100px_100px_100px_100px_120px] gap-1 px-4 py-3 text-sm font-semibold" style={{ color: 'var(--text-slate-700)', width: listWidth }}>
                {bulkEditMode &&
              <div className="flex items-center justify-center">
                    <Checkbox
