...
import DriverRouteControlsSection from '@/components/dashboard/DriverRouteControlsSection';

export default function DashboardExpandedControls(props) {
  const {
    selectedDriverId,
    handleDriverChange,
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  if (checked) {
                    ...
                    try {
                      const selectedDateStr = new Intl.DateTimeFormat('en-CA').format(selectedDate);
