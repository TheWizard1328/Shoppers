  ...
  return (
    <>
      ...
      >
        ...
        {/* Column headers */}
        <div className="grid grid-cols-[40px_56px_minmax(0,1fr)_96px] gap-x-1 px-3 py-2 bg-slate-100 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-500 dark:text-slate-400">
          <div className="text-center">#</div>
          <div className="text-center">Old ETA</div>
          <div className="text-center">Stop</div>
          <div className="text-right pr-1">New ETA / #</div>
        </div>
            ...
            sorted.map((row, idx) => {
              ...
              return (
                <div
                  ...
                  className={`grid grid-cols-[40px_56px_minmax(0,1fr)_96px] gap-x-1 px-3 py-2 items-center border-b text-xs ${
                    moved
                ...
                >
                  ...
                  {/* New ETA + store badge + new stop order — all on one row */}
                  <div className="col-span-2 flex items-center justify-end gap-1.5">
                    ...
                    <span className="font-mono font-bold text-emerald-700 dark:text-emerald-400 w-6 text-right flex-shrink-0">
