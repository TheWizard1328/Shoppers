    ...
    <div className={statsCardPositioning} style={{ zIndex: isMobile && isExpanded ? 40 : isMobile ? 100 : 600, position: 'absolute', pointerEvents: 'none' }}>
      ...
      onMouseLeave={() => handleStatsPanelInteraction(false)}>
        ...
        <motion.div
          ...
          animate={{ opacity: hideCards ? 0 : 1, y: hideCards ? -140 : 0 }}
        ...
        <div className="backdrop-blur-sm rounded-xl shadow-lg border h-auto overflow-visible w-full min-w-[340px] max-w-[345px]" style={{ background: 'var(--bg-white)', opacity: 0.95, borderColor: 'var(--border-slate-200)' }}
