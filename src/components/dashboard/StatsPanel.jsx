                ...
                {isPureDispatcher ?
                  <div className="flex items-stretch rounded-md overflow-hidden border flex-shrink-0 select-none h-11" style={{ borderColor: 'var(--border-slate-300)' }}>
                    <button
                      ...
                      className={`flex-1 flex items-center justify-between gap-1 h-full transition-colors text-xs font-semibold pr-2 pl-2 ${interStoreMode === 'pickup' ? 'bg-emerald-600 hover:bg-emerald-700 text-white' : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700'}`}>
