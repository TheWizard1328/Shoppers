                   ...
                   <table className="border-collapse">
                     <tbody>
                       ...
                       <tr className="text-lg font-bold text-emerald-600">
                         ...
                         <td className="text-right pt-1">{(data.grandTotal + Math.round(data.taxAmount * 100) / 100 + (edit.bonusPay || 0) - (edit.deductions?.reduce((sum, d) => sum + (d?.amount || 0), 0) || 0) + calculateAppFeeAmount(driverKey, edit.appFeePercent)).toFixed(2)}</td>
                       </tr>
                     </tbody>
                     </table>
                     </div>
