                   ...
                   <table className="border-collapse">
                     <tbody>
                       ...
                       <tr className="text-lg font-bold text-emerald-600">
                         ...
                         <td className="text-right pt-1">{(Math.round((data.grandTotal + data.taxAmount + (edit.bonusPay || 0) - (edit.deductions?.reduce((sum, d) => sum + (d?.amount || 0), 0) || 0) + calculateAppFeeAmount(driverKey, edit.appFeePercent)) * 100) / 100).toFixed(2)}</td>
                       </tr>
                     </tbody>
                     </table>
                     </div>
