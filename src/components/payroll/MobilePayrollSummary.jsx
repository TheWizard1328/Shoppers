...
export default function MobilePayrollSummary({ periodLabel, totalNetPay, totalDeliveries, onPrev, onNext }) {
  ...
  return (
    <div className="lg:hidden sticky top-16 z-10 mb-3 bg-white/95 backdrop-blur border border-slate-200 rounded-xl p-3 shadow-sm">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <div className="text-[11px] text-slate-500 leading-tight">Net Pay</div>
            <div className="text-base font-semibold leading-tight">{money}</div>
          </div>
          <div className="h-8 w-px bg-slate-200" />
          <div className="text-right">
            <div className="text-[11px] text-slate-500 leading-tight">Deliveries</div>
