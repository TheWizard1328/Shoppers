      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        <div className="card-container" style={{
          ...
          {stores.map((store) => {
            ...
            return (
              <Card
                key={store.id} className="rounded-xl border text-card-foreground shadow cursor-pointer hover:shadow-md transition-all duration-200 bg-white min-w-[300px]"
    ...
    <div className="h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <>
            ...
            <div
            className="bg-slate-100 border-l border-slate-200 p-6 overflow-y-auto hidden lg:block"
