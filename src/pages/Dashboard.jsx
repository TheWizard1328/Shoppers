...
function Dashboard() {
  ...
  const getMapPadding = useCallback((isImmersiveModeOn = false) => buildMapPadding({ isMobile, isImmersiveModeOn, statsCardHeight: statsCardRef.current?.offsetHeight, statsCardBaseHeight, stopCardsBaseHeight, bottomNavHeight }), [isMobile, stopCardsBaseHeight, statsCardBaseHeight, bottomNavHeight]);
