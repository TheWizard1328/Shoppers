    ...
    <div className="h-full w-full flex flex-col bg-slate-50 overflow-hidden">
      ...
      <div className="flex-1 w-full relative min-h-0">
        ...
        <div
            ...
            className="horizontal-cards-container absolute bottom-0 left-0 right-0 z-[150] px-4 pb-2 pointer-events-none flex flex-col justify-end min-h-[145px] max-h-[80vh]"
            onClick={() => {
              if (retractClustersRef.current) {
                retractClustersRef.current();
              }
