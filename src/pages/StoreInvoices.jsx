        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="pt-6">
              <div className="text-sm text-slate-600 dark:text-slate-400 mb-2">Draft Invoices</div>
              <div className="text-2xl font-bold mb-1">{draftInvoices.length}</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">${totalDraft.toFixed(2)}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-sm text-slate-600 dark:text-slate-400 mb-2">Approved & Pending</div>
              <div className="text-2xl font-bold mb-1">{approvedInvoices.length}</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">${totalApproved.toFixed(2)}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="pt-6">
              <div className="text-sm text-slate-600 dark:text-slate-400 mb-2">Sent Invoices</div>
              <div className="text-2xl font-bold mb-1">{sentInvoices.length}</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">${totalSent.toFixed(2)}</div>
            </CardContent>
          </Card>
        </div>
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-slate-600 dark:text-slate-400">{invoice.store_name}</div>
