...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // =============================================
    // STEP 8: Polyline generation - DISABLED
    // =============================================
    console.log('');
    console.log('🏗️ STEP 8: Polyline generation - BYPASSED');
    console.log('   ⏭️ Polyline generation is disabled to prevent potential errors');
